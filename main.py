...
class Calcul:
    ...
    def delta(self):
        ...
        if self.delta > 0:
            print("Le discriminant Δ est positif. Ainsi il y a 2 racines réelles")
        elif self.delta == 0:
            print("Le discriminant Δ est neutre. Il y a alors une racine double.")
        else:
            print("Le discriminant Δ est négatif. Il n'y a pas de solution réelle")
